...
const ThirdTab = () => {
  return (
    ...
    <div className="row">
          <div className="col-lg-5 col-md-12 left pe-5 pb-md-3 pt-md-3 p-md-5">
            <h2 className="tabs-content-title">Corporate Event</h2>
          ...
          <TabImg className="col-lg-7 col-md-12 tabs-img m-0 ps-5  mt-5 mt-md-0 ps-md-0 ps-md-5 d-flex align-items-center">
        <img src="/corporate-event.jpg" alt="tab_3_img" />
          </TabImg>
    </div>
